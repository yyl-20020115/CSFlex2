...
//#line default
public sealed class LexScan : SymbolContants, IScanner
{
...
1, 9, 0 };
    ...
    internal File file;
    internal System.Collections.Stack files = new System.Collections.Stack();
            ...
            switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction])
            {
                ...
                case 135:
                    if (ZZ_SPURIOUS_WARNINGS_SUCK)
                    {
                        ...
                        bufferSize = IntegerUtil.ParseInt(Yytext().Substring(8).Trim());
                        //#line default
                    }
                    break;
                case 79:
                ...
                case 68:
                    if (ZZ_SPURIOUS_WARNINGS_SUCK)
                    {
                        ...
                        return Symbol(CHAR, (char)IntegerUtil.ParseInt(Yytext().Substring(1, Yytext().Length - 1), 8));
                        //#line default
                    }
                    break;
                case 29:
                ...
                case 101:
                    if (ZZ_SPURIOUS_WARNINGS_SUCK)
                    {
                        ...
                        return Symbol(CHAR, (char)IntegerUtil.ParseInt(Yytext().Substring(2, Yytext().Length - 2), 16));
                        //#line default
                    }
                    break;
                case 146:
                ...
                case 80:
                    if (ZZ_SPURIOUS_WARNINGS_SUCK)
                    {
                        ...
                        @string.Append((char)IntegerUtil.ParseInt(Yytext().Substring(1, Yytext().Length - 1), 8));
                        //#line default
                    }
                    break;
                case 91:
                ...
                case 102:
                    if (ZZ_SPURIOUS_WARNINGS_SUCK)
                    {
                        ...
                        @string.Append((char)IntegerUtil.ParseInt(Yytext().Substring(2, Yytext().Length - 2), 16));
                        //#line default
                    }
                    break;
                case 58:
    ...
    private string GetTokenName(int token)
    {
        try
        {
            System.Reflection.FieldInfo[] classFields = typeof(SymbolContants).GetFields();
    ...
    yyline + 1, yycolumn + 1, Yytext(), GetTokenName(s.symbol));
        return s;
    }
