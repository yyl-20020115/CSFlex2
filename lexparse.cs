...
namespace CSFlex
{
	...
	public class LexParse : LR_Parser
	{
		...
		public LexParse(IScanner s) : base(s) { }
		...
		public override void Report_error(string message, object info)
		{
			if (info is Symbol)
			{
				...
				if (s.symbol == SymbolContants.EOF)
	...
	public class CUP_LexParse_actions
	{
		...
		internal Stopwatch t = new Stopwatch();
		...
		private bool Check(int type, char c)
		{
			switch (type)
			{
				case SymbolContants.JLETTERCLASS:
					if (jletter_map == null)
					{
				...
				case SymbolContants.JLETTERDIGITCLASS:
				...
				case SymbolContants.LETTERCLASS:
					return char.IsLetter(c);

				case SymbolContants.DIGITCLASS:
					return char.IsDigit(c);

				case SymbolContants.UPPERCLASS:
					return char.IsUpper(c);

				case SymbolContants.LOWERCLASS:
		...
		private List<Interval> MakePreClass(int type)
		{

			List<Interval> result = new PrettyList<Interval>();

			char c = (char)0;
			char start = (char)0;
			char last = charClasses.MaxCharCode;
		...
		private RegExp MakeRepeat(RegExp r, int n1, int n2, int line, int col)
		{
			...
			{
				result = new RegExp1(SymbolContants.QUESTION, r);
				n2--;
			}

			for (i = 0; i < n1; i++)
				result = new RegExp2(SymbolContants.CONCAT, result, r);

			n2 -= n1;
			for (i = 0; i < n2; i++)
				result = new RegExp2(SymbolContants.CONCAT, result, new RegExp1(SymbolContants.QUESTION, r));
		...
		{
            var list = new PrettyList<Interval>
            {
                new Interval('\n', '\r'),
                new Interval('\u0085', '\u0085'),
                new Interval('\u2028', '\u2029')
			...
			RegExp1 c = new RegExp1(SymbolContants.CCLASS, list);
			char n = '\n';
			char r = '\r';

			return new RegExp2(SymbolContants.BAR,
							   c,
							   new RegExp2(SymbolContants.CONCAT,
										   new RegExp1(SymbolContants.CHAR, r),
										   new RegExp1(SymbolContants.CHAR, n)));
		}
		...
		public Symbol CUP_LexParse_do_action(
		  ...
		  ListStack<Symbol> CUP_LexParse_stack,
		  int CUP_LexParse_top)
		{
			...
			switch (CUP_LexParse_act_num)
			{
				...
				case 72: // preclass ::= LOWERCLASS 
					{
						...
						RESULT = MakePreClass(SymbolContants.LOWERCLASS);
						//#line default

						CUP_LexParse_result = new Symbol(15/*preclass*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
				...
				case 71: // preclass ::= UPPERCLASS 
					{
						...
						RESULT = MakePreClass(SymbolContants.UPPERCLASS);
						//#line default
				...
				case 70: // preclass ::= DIGITCLASS 
					{
						...
						RESULT = MakePreClass(SymbolContants.DIGITCLASS);
						//#line default
				...
				case 69: // preclass ::= LETTERCLASS 
					{
						...
						RESULT = MakePreClass(SymbolContants.LETTERCLASS);
						//#line default
				...
				case 68: // preclass ::= JLETTERDIGITCLASS 
					{
						...
						RESULT = MakePreClass(SymbolContants.JLETTERDIGITCLASS);
						//#line default
				...
				case 67: // preclass ::= JLETTERCLASS 
					{
						...
						RESULT = MakePreClass(SymbolContants.JLETTERCLASS);
						//#line default
				...
				case 66: // classcontentelem ::= CHAR 
					{
						...
						int cleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int cright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						char c = (char)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

						//#line 1303 "LexParse.cup"
						RESULT = new Interval(c, c);
						//#line default

						CUP_LexParse_result = new Symbol(11/*classcontentelem*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 65: // classcontentelem ::= CHAR DASH CHAR 
					{
						Interval RESULT = null;
						int c1left = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left;
						int c1right = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).right;
						char c1 = (char)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).value;
						int c2left = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int c2right = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						char c2 = (char)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

						//#line 1301 "LexParse.cup"
						RESULT = new Interval(c1, c2);
						//#line default

						CUP_LexParse_result = new Symbol(11/*classcontentelem*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 64: // classcontent ::= MACROUSE 
					{
                        List<Interval> RESULT = null;
						int identleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int identright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						string ident = (string)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
						...
						CUP_LexParse_result = new Symbol(14/*classcontent*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 63: // classcontent ::= classcontent MACROUSE 
					{
                        List<Interval> RESULT = null;
						int listleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int listright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
                        List<Interval> list = (List<Interval>)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;
						int identleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int identright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						string ident = (string)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
						...
						CUP_LexParse_result = new Symbol(14/*classcontent*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 62: // classcontent ::= STRING 
					{
                        List<Interval> RESULT = null;
						int sleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int sright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						string s = (string)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

						//#line 1285 "LexParse.cup"

						RESULT = new List<Interval>();
				...
				case 60: // classcontent ::= preclass 
					{
						...
						int listleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int listright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						ArrayList list = (ArrayList)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
				...
				case 59: // classcontent ::= classcontent preclass 
					{
						...
						int listleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int listright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						ArrayList list = (ArrayList)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;
						int plistleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int plistright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						ArrayList plist = (ArrayList)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
				...
				case 58: // classcontent ::= classcontentelem 
					{
                        List<Interval> RESULT = null;
						int elemleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int elemright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						Interval elem = (Interval)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

                        //#line 1265 "LexParse.cup"

                        List<Interval> list = new PrettyList<Interval>();
						list.Add(elem);
						RESULT = list;
				...
				case 56: // charclass ::= OPENCLASS HAT DASH classcontent CLOSECLASS 
					{
						...
						int listright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						List<Interval> list = (List<Interval>)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;
						int closeleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int closeright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						object close = (object)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
						...
						RESULT = new RegExp1(SymbolContants.CCLASSNOT, list);

						//#line default

						CUP_LexParse_result = new Symbol(9/*charclass*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 4)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 55: // charclass ::= OPENCLASS DASH classcontent CLOSECLASS 
					{
						...
						RESULT = new RegExp1(SymbolContants.CCLASS, list);

						//#line default

						CUP_LexParse_result = new Symbol(9/*charclass*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 53: // charclass ::= OPENCLASS HAT CLOSECLASS 
					{
						...
						CUP_LexParse_result = new Symbol(9/*charclass*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 51: // charclass ::= OPENCLASS CLOSECLASS 
					{
						...
						RESULT = new RegExp1(SymbolContants.CCLASS, null);

						//#line default

						CUP_LexParse_result = new Symbol(9/*charclass*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 50: // regexp ::= CHAR 
					{
						...
						try
						{
							if (scanner.caseless)
							{
								...
								RESULT = new RegExp1(SymbolContants.CHAR_I, c);
							}
							else
							{
								charClasses.MakeClass(c, false);
								RESULT = new RegExp1(SymbolContants.CHAR, c);
							}
						}
						catch (CharClassException)
						{
						...
						CUP_LexParse_result = new Symbol(8/*regexp*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 49: // regexp ::= POINT 
					{
						...
						charClasses.MakeClass('\n', false);
						RESULT = new RegExp1(SymbolContants.CCLASSNOT, any);
				...
				case 48: // regexp ::= STRING 
					{
						RegExp RESULT = null;
						int strleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int strright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						string str = (string)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
						...
						try
						{
							if (scanner.caseless)
							{
								...
								RESULT = new RegExp1(SymbolContants.STRING_I, str);
							}
							else
							{
								charClasses.MakeClass(str, false);
								RESULT = new RegExp1(SymbolContants.STRING, str);
							}
						}
						catch (CharClassException)
						{
				...
				case 47: // regexp ::= preclass 
					{
						...
						int listleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int listright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						List<Interval> list = (List<Interval>)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
				...
				case 46: // regexp ::= charclass 
					{
						...
						int cleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int cright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						RegExp c = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
				...
				case 45: // regexp ::= MACROUSE 
					{
						...
						RESULT = new RegExp1(SymbolContants.MACROUSE, ident);
				...
				case 44: // regexp ::= OPENBRACKET series CLOSEBRACKET 
					{
						RegExp RESULT = null;
						int rleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int rright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						RegExp r = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;

						//#line 1133 "LexParse.cup"
						RESULT = r;
						//#line default

						CUP_LexParse_result = new Symbol(8/*regexp*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 43: // regexp ::= regexp REPEAT REPEAT RBRACE 
					{
						RegExp RESULT = null;
						int rleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).left;
						int rright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).right;
						RegExp r = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).value;
						int n1left = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left;
						int n1right = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).right;
						int n1 = (int)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).value;
						int n2left = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int n2right = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						int n2 = (int)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;

						//#line 1131 "LexParse.cup"
						RESULT = MakeRepeat(r, n1, n2, n1left, n2right);
						//#line default

						CUP_LexParse_result = new Symbol(8/*regexp*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 42: // regexp ::= regexp REPEAT RBRACE 
					{
						RegExp RESULT = null;
						int rleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left;
						int rright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).right;
						RegExp r = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).value;
						int nleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int nright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						int n = (int)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;
						int bleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int bright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						object b = (object)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
				...
				case 41: // regexp ::= regexp QUESTION 
					{
						...
						CUP_LexParse_result = new Symbol(8/*regexp*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 40: // regexp ::= regexp PLUS 
					{
						...
						RESULT = new RegExp1(SymbolContants.PLUS, r);
						//#line default
				...
				case 39: // regexp ::= regexp STAR 
					{
						...
						RESULT = new RegExp1(SymbolContants.STAR, r);
						//#line default
				...
				case 38: // nregexp ::= TILDE nregexp 
					{
						RegExp RESULT = null;
						int rleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int rright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						RegExp r = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

						//#line 1119 "LexParse.cup"
						RESULT = new RegExp1(SymbolContants.TILDE, r);
						//#line default

						CUP_LexParse_result = new Symbol(7/*nregexp*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 37: // nregexp ::= BANG nregexp 
					{
						...
						RESULT = new RegExp1(SymbolContants.BANG, r);
						//#line default
				...
				case 36: // nregexp ::= regexp 
					{
						...
						CUP_LexParse_result = new Symbol(7/*nregexp*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 35: // concs ::= nregexp 
					{
						...
						CUP_LexParse_result = new Symbol(6/*concs*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 34: // concs ::= concs nregexp 
					{
						RegExp RESULT = null;
						int r1left = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int r1right = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						RegExp r1 = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;
						int r2left = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int r2right = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						RegExp r2 = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

						//#line 1109 "LexParse.cup"
						RESULT = new RegExp2(SymbolContants.CONCAT, r1, r2);
						//#line default

						CUP_LexParse_result = new Symbol(6/*concs*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 33: // series ::= BAR 
					{
						...
						CUP_LexParse_result = new Symbol(5/*series*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 31: // series ::= series BAR concs 
					{
						RegExp RESULT = null;
						int r1left = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left;
						int r1right = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).right;
						RegExp r1 = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).value;
						int r2left = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int r2right = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						RegExp r2 = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

						//#line 1101 "LexParse.cup"
						RESULT = new RegExp2(SymbolContants.BAR, r1, r2);
						//#line default

						CUP_LexParse_result = new Symbol(5/*series*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 30: // hatOPT ::= 
					{
						...
						CUP_LexParse_result = new Symbol(17/*hatOPT*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 29: // hatOPT ::= HAT 
					{
						...
						CUP_LexParse_result = new Symbol(17/*hatOPT*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 28: // states ::= IDENT COMMA 
					{
						...
						int cleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int cright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						object c = (object)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

						//#line 1089 "LexParse.cup"
						SyntaxError(ErrorMessages.REGEXP_EXPECTED, cleft, cright + 1);
						//#line default

						CUP_LexParse_result = new Symbol(12/*states*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 27: // states ::= IDENT 
					{
						...
						int idleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int idright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						string id = (string)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

                        //#line 1077 "LexParse.cup"

                        List<int> list = new PrettyList<int>();
						stateNumber = scanner.states.GetNumber(id);
						if (stateNumber != null)
							list.Add(stateNumber.Value);
						else
						{
						...
						CUP_LexParse_result = new Symbol(12/*states*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 26: // states ::= IDENT COMMA states 
					{
						ArrayList RESULT = null;
						int idleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left;
						int idright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).right;
						string id = (string)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).value;
						int listleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int listright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						ArrayList list = (ArrayList)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
						...
						CUP_LexParse_result = new Symbol(12/*states*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 25: // statesOPT ::= 
					{
						...
						RESULT = new PrettyList<int>();
						//#line default

						CUP_LexParse_result = new Symbol(13/*statesOPT*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 24: // statesOPT ::= LESSTHAN states MORETHAN 
					{
						...
						CUP_LexParse_result = new Symbol(13/*statesOPT*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 23: // actions ::= NOACTION 
					{
						...
						CUP_LexParse_result = new Symbol(18/*actions*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 22: // actions ::= REGEXPEND ACTION 
					{
						Action RESULT = null;
						int aleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int aright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						Action a = (Action)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

						//#line 1053 "LexParse.cup"
						RESULT = a;
						//#line default

						CUP_LexParse_result = new Symbol(18/*actions*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 21: // lookaheadOPT ::= LOOKAHEAD series DOLLAR 
					{
						RegExp RESULT = null;
						int sleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int sright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						RegExp s = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;

						//#line 1049 "LexParse.cup"
						RESULT = new RegExp2(SymbolContants.CONCAT, s, MakeNL());
						//#line default

						CUP_LexParse_result = new Symbol(10/*lookaheadOPT*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 20: // lookaheadOPT ::= 
					{
						...
						CUP_LexParse_result = new Symbol(10/*lookaheadOPT*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 19: // lookaheadOPT ::= LOOKAHEAD series 
					{
						...
						CUP_LexParse_result = new Symbol(10/*lookaheadOPT*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 18: // lookaheadOPT ::= DOLLAR 
					{
						...
						CUP_LexParse_result = new Symbol(10/*lookaheadOPT*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 17: // rule ::= error 
					{
						...
						CUP_LexParse_result = new Symbol(3/*rule*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 16: // rule ::= statesOPT EOFRULE ACTION 
					{
						object RESULT = null;
						int sleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left;
						int sright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).right;
						ArrayList s = (ArrayList)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).value;
						int aleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int aright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						Action a = (Action)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
						...
						CUP_LexParse_result = new Symbol(3/*rule*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 15: // rule ::= statesOPT hatOPT series lookaheadOPT actions 
					{
						object RESULT = null;
						int sleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 4)).left;
						int sright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 4)).right;
						ArrayList s = (ArrayList)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 4)).value;
						int bolleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).left;
						int bolright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).right;
						Boolean bol = (Boolean)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).value;
						int rleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).left;
						int rright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).right;
						RegExp r = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 2)).value;
						int lleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int lright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						RegExp l = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;
						int aleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int aright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						Action a = (Action)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;
						...
						CUP_LexParse_result = new Symbol(3/*rule*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 4)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 14: // rules ::= rule 
					{
						...
						int rleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int rright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						int r = (int)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

						//#line 1032 "LexParse.cup"
						RESULT = new PrettyList<int>(); RESULT.Add(r);
						//#line default

						CUP_LexParse_result = new Symbol(16/*rules*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 13: // rules ::= LESSTHAN states MORETHAN LBRACE rules RBRACE 
					{
						ArrayList RESULT = null;
						int statesleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 4)).left;
						int statesright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 4)).right;
						ArrayList states = (ArrayList)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 4)).value;
						int rlistleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int rlistright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						ArrayList rlist = (ArrayList)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;
						...
						CUP_LexParse_result = new Symbol(16/*rules*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 5)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 12: // rules ::= rules LESSTHAN states MORETHAN LBRACE rules RBRACE 
					{
						ArrayList RESULT = null;
						int rlist1left = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 6)).left;
						int rlist1right = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 6)).right;
						ArrayList rlist1 = (ArrayList)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 6)).value;
						int statesleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 4)).left;
						int statesright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 4)).right;
						ArrayList states = (ArrayList)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 4)).value;
						int rlist2left = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int rlist2right = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						ArrayList rlist2 = (ArrayList)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;
						...
						CUP_LexParse_result = new Symbol(16/*rules*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 6)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 11: // rules ::= rules rule 
					{
						...
						CUP_LexParse_result = new Symbol(16/*rules*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 10: // macro ::= IDENT EQUALS 
					{
						object RESULT = null;
						int eleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left;
						int eright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right;
						object e = (object)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).value;

						//#line 1006 "LexParse.cup"
						SyntaxError(ErrorMessages.REGEXP_EXPECTED, eleft, eright);
						//#line default

						CUP_LexParse_result = new Symbol(2/*macro*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 9: // macro ::= IDENT EQUALS series REGEXPEND 
					{
						object RESULT = null;
						int nameleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).left;
						int nameright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).right;
						string name = (string)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).value;
						int definitionleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int definitionright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						RegExp definition = (RegExp)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;

						//#line 1004 "LexParse.cup"
						macros.Insert(name, definition);
						//#line default

						CUP_LexParse_result = new Symbol(2/*macro*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 8: // macro ::= UNICODE 
					{
						...
						charClasses.
						//#line 1002 "LexParse.cup"
						MaxCharCode = (char)0xFFFF;
						//#line default

						CUP_LexParse_result = new Symbol(2/*macro*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 6: // macros ::= error 
					{
						...
						CUP_LexParse_result = new Symbol(1/*macros*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 5: // macros ::= macros macro 
					{
						...
						CUP_LexParse_result = new Symbol(1/*macros*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 4: // macros ::= 
					{
						...
						CUP_LexParse_result = new Symbol(1/*macros*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 3: // specification ::= 
					{
						...
						CUP_LexParse_result = new Symbol(4/*specification*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 2: // specification ::= USERCODE macros DELIMITER rules DELIMITER EPILOGUE 
					{
						...
						SemCheck.Check(regExps, macros, charClasses.MaxCharCode, scanner.file);
						...
						RESULT = new NFA(charClasses.ClassesCount,
						...
						CUP_LexParse_result = new Symbol(4/*specification*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 5)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 1: // specification ::= USERCODE macros DELIMITER rules 
					{
						...
						CUP_LexParse_result = new Symbol(4/*specification*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 3)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					return CUP_LexParse_result;
				...
				case 0: // $START ::= specification EOF 
					{
						object RESULT = null;
						int start_valleft = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left;
						int start_valright = ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).right;
						NFA start_val = (NFA)((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).value;
						RESULT = start_val;
						CUP_LexParse_result = new Symbol(0/*$START*/, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 1)).left, ((Symbol)CUP_LexParse_stack.ElementAt(CUP_LexParse_top - 0)).right, RESULT);
					}
					/* ACCEPT */
