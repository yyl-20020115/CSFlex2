...
public class CharClasses
{
    ...
    /** the char classes */
    private readonly List<IntCharSet> classes;
    ...
    {
        if (maxCharCode < 0 || maxCharCode > char.MaxValue)
            throw new ArgumentException();

        this.maxCharUsed = (char)maxCharCode;

        this.classes = [new IntCharSet(new Interval((char)0, maxChar))];
    }
 ...
 */
	 ...
	 * @param caseless  if true upper/lower/title case are considered equivalent  
	 */
    public void MakeClass(List<Interval> v, bool caseless) => MakeClass(new IntCharSet(v), caseless);
	 ...
	 * @param caseless  if true upper/lower/title case are considered equivalent  
	 */
    public void MakeClassNot(List<Interval> v, bool caseless) => MakeClass(new IntCharSet(v), caseless);
